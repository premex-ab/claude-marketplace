...
**Upstream:** [`android/skills/profilers/perfetto-sql`](https://github.com/android/skills/tree/main/profilers/perfetto-sql) — mirrored and split into a one-plugin-per-skill layout so you can install skills individually. Auto-synced daily from upstream; the SKILL.md is Google-authored.

## Install

```bash
/plugin install android-perfetto-sql@premex-plugins
```

## What's in the box

- `skills/perfetto-sql/SKILL.md` — the skill definition
- `skills/perfetto-sql/references/` — supporting docs referenced from the skill
