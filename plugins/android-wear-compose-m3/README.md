...
```bash
/plugin install android-wear-compose-m3@premex-plugins
```

## What's in the box

- `skills/wear-compose-m3/SKILL.md` — the skill definition
- `skills/wear-compose-m3/references/` — supporting docs referenced from the skill
