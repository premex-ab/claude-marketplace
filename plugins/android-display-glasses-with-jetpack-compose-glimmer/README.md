...
**Upstream:** [`android/skills/xr/display-glasses-with-jetpack-compose-glimmer`](https://github.com/android/skills/tree/main/xr/display-glasses-with-jetpack-compose-glimmer) — mirrored and split into a one-plugin-per-skill layout so you can install skills individually. Auto-synced daily from upstream; the SKILL.md is Google-authored.

## Install

```bash
/plugin install android-display-glasses-with-jetpack-compose-glimmer@premex-plugins
```

## What's in the box

- `skills/display-glasses-with-jetpack-compose-glimmer/SKILL.md` — the skill definition
- `skills/display-glasses-with-jetpack-compose-glimmer/references/` — supporting docs referenced from the skill
