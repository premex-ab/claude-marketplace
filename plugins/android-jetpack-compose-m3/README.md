...
**Upstream:** [`android/skills/wear/jetpack-compose-m3`](https://github.com/android/skills/tree/main/wear/jetpack-compose-m3) — mirrored and split into a one-plugin-per-skill layout so you can install skills individually. Auto-synced daily from upstream; the SKILL.md is Google-authored.

## Install

```bash
/plugin install android-jetpack-compose-m3@premex-plugins
```

## What's in the box

- `skills/jetpack-compose-m3/SKILL.md` — the skill definition
- `skills/jetpack-compose-m3/references/` — supporting docs referenced from the skill
