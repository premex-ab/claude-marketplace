...
> Orchestrates Android development tasks

**Upstream:** [`android/skills/android-cli/base`](https://github.com/android/skills/tree/main/android-cli/base) — mirrored and split into a one-plugin-per-skill layout so you can install skills individually. Auto-synced daily from upstream; the SKILL.md is Google-authored.

## Install

```bash
/plugin install android-base@premex-plugins
```

## What's in the box

- `skills/base/SKILL.md` — the skill definition
